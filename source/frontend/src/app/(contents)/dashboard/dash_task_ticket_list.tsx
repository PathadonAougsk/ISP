...
function TaskList({
    ...
    useEffect(() => {
        async function loadUsernames() {
            const uniqueUserIds = [
                ...new Set(tasks.map((task) => task.created_by)),
            ];
                ...
                <div className="flex flex-col gap-2">
                    {tickets.map((ticket) => {
                        ...
                        return (
                            <div
                                key={ticket.id}
                                className={`flex h-8 items-center gap-4 rounded-[20px] px-2 ${isAccepted ? "bg-gray-100" : "bg-white"
                                    }`}
                            >
                                <Image
                                ...
                                <div className="grid flex-1 grid-cols-[2fr_1.4fr_1.4fr_1.4fr] items-center gap-2">
                                    <p
                                        className={`truncate text-sm ${isAccepted ? "text-gray-400" : "text-black"
                                            }`}
                                    >
                                        {ticket.name}
                                    </p>
                                    ...
                                    <p
                                        className={`text-sm ${isAccepted ? "text-gray-400" : "text-black"
                                            }`}
                                    >
